...
export const TECH_NODES: TechNode[] = [
    ...
    { id: 'mini_balista_racial', x: 1700, y: 1150, category: 'weapon', pt: 'Mini Balista Aprimorada', en: 'Enhanced Mini Ballista', desc_pt: 'Racial Aerions - CP nv 9.', desc_en: 'Aerions Racial - CP lvl 9.', requirements: ['mini_balista'], baseTime: '20d' },
