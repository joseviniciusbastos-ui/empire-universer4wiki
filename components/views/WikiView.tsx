    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Button variant="primary" onClick={onCreateClick}>NOVA ENTRADA</Button>
            </div>
                ...
                <div className="md:col-span-1 space-y-2">
                    <Card title="Categorias" className="p-4">
                        <ul className="space-y-3 font-heading text-lg text-space-muted uppercase tracking-wider">
                            <li onClick={() => onCategoryClick('')} className="hover:text-space-neon cursor-pointer text-space-neon font-bold">Todas as Entradas</li>
                            {categories.map(cat => (
